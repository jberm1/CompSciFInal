...
public class GraphicsPanel extends JPanel  implements KeyListener{
	...
	public GraphicsPanel()
	{
		...
		for(int i=0;i<100;i++){
			...
			trees.add(new Character(6,(int)(Math.random()*4000)+500,(int)(Math.random()*4000)+1,0,50));
		}
	...
	public void paintComponent(Graphics g)
	{
		...
		if(gameOver==true){
			...
			g2.setColor(Color.RED);
			g2.setFont(new Font("Zapfino", 0, 85));
			g2.drawString("GAMEOVER", 10, 300);
			String imagePath1 = "images/blood.png";
			ClassLoader cldr1 = this.getClass().getClassLoader();
			URL imageURL1 = cldr1.getResource(imagePath1);
			ImageIcon image1 = new ImageIcon(imageURL1);				// images directory.
			image1.paintIcon(this, g2, 255,380);
			g2.setColor(Color.RED);	
			g2.setFont(new Font("Zapfino", 0, 60));
			g2.drawString("WAVE " + round, 270, 500);
		}
